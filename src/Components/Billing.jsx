    ...
    <div className={layout.sectionInfo}>
        <h2 className={styles.heading2}>Easily control your <br  className='sm:block hidden'/>
         ...
         <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
           Elite enim sger  ed massa etim. Mauris eu adipiscing ulterices ametodio aenean neque. Fusce ipsum orci rhoncus aliporttitor inte platea placerat
         </p>
          <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
          <img src={apple} alt="apple_store"  className='w-[128px] h-[42px] object-contain mr-5 cursor-pointer'/>
          <img src={google} alt="ggogle_play"  className='w-[128px] h-[42px] object-contain cursor-pointer'/>
          </div>
    </div>
